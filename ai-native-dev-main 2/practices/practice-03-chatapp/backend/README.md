...
## **Note**: The MODEL_NAME value can be updated to any supported OpenAI model. Currently supported models: `gpt-4o`, `gpt-4o-mini`, `gpt-4-turbo`, `gpt-3.5-turbo`. Always refer to [OpenAI's documentation](https://platform.openai.com/docs/models) for the latest options.
